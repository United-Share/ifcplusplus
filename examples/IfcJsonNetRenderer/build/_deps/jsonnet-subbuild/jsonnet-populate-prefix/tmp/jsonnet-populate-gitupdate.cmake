...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v0.20.0"
  WORKING_DIRECTORY "/workspace/examples/IfcJsonNetRenderer/build/_deps/jsonnet-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workspace/examples/IfcJsonNetRenderer/build/_deps/jsonnet-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workspace/examples/IfcJsonNetRenderer/build/_deps/jsonnet-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
